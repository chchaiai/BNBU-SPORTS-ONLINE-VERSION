...
test("statistics keep official members, platform members, and resolution state separate", () => {
  ...
  const ambiguous = deriveStats({...currentRoster,version:{...currentRoster.version,validRows:0,duplicatedRows:2}},results,members,'1');
  assert.equal(ambiguous.officialTotal,null);
