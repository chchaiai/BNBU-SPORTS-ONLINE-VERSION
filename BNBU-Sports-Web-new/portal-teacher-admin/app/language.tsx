...
const englishText: Record<string, string> = {
  ...
  "请选择模板允许的运动门槛和每周次数。": "Select a duration threshold and weekly limit allowed by the template.",
  ...
  "运动门槛": "Exercise duration threshold",
  ...
  "总目标为 1,200 分钟。课程发布后，运动门槛、周频次和时间安排锁定。": "The total target is 1,200 minutes. Exercise thresholds, weekly frequency and scheduling are locked after publication.",
