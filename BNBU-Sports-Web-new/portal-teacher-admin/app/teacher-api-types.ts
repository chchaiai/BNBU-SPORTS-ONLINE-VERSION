...
export type StructuredExemptionApplication =
  Omit<ContractSchemas["StructuredExemptionApplication"],"status"> & {
    // Current local candidate adds retained certification revocations.
    status: ContractSchemas["StructuredExemptionApplication"]["status"] | "REVOKED";
  };
...
export type ReviewResult = "VALID" | "INVALID" | "PENDING";
