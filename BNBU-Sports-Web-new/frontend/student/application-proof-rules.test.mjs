...
test('application images accept the documented formats and exact ten MB ceiling',()=>{
 ...
 for(const type of ['application/pdf','video/webm','image/gif',''])assert.equal(validateApplicationProofFile({type,size:10}).ok,false);
