...
export async function uploadMediaDraft(serverSessionId, draft, blob, { prepareOnly = false } = {}) {
...
export async function uploadExemptionApplicationMediaDraft(enrollmentId, draft, blob) {
