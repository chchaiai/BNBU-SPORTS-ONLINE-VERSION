...
WORK = Path('/home/ubuntu/bnbu-media-upload-recovery-20260915')
RELEASE = BASE / 'releases/media-upload-recovery-20260915'
...
try:
    ...
    health = {url: len(http(url)) for url in [
        ...
        'https://student.bnbusports.cn/student/',
        'https://www.student.bnbusports.cn/api/v1/health/ready',
        'https://www.teacher.bnbusports.cn/',
        'https://bnbusports.cn/']}
    for origin in ['https://student.bnbusports.cn', 'https://www.student.bnbusports.cn']:
    ...
    result = {'result': 'PASS', 'release': str(RELEASE), 'previous': str(previous), 'image': prepared['image'],
              ...
              'migrationExecuted': False, 'realStudentBusinessWrites': 0, 'rollbackExercised': False}
