import { isNewStudentSchoolEmail } from "../student-school-email.js";
...
const isSchoolEmail = isNewStudentSchoolEmail;
...
export function renderContactBinding(app, { mode }) {
  ...
  const emailError = state.email.trim() && !emailValid
    ? tx("邮箱格式不正确，请输入 1 个小写字母 + 9 位数字的学生邮箱前缀，并使用 @mail.bnbu.edu.cn。", "Use one lowercase letter and nine digits before @mail.bnbu.edu.cn.")
