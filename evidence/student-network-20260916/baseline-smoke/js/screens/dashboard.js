...
export function renderDashboard(app) {
  ...
  if (hasEnrollment) {
    ...
    const serverCheck = app.isApiMode();
    const isLoadingPolicy = !serverCheck && timeWindow.windowMode === "unavailable";
    const blockedReason = serverCheck || isLoadingPolicy ? null : canStartExercise(timeWindow);
