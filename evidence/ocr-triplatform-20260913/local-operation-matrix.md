...
| Metric | Count |
| --- | ---: |
| Contract operations | 263 |
| Runtime validation complete | 263 |
| Runtime validation incomplete | 0 |
| No observed response | 0 |
| Intentionally disabled with validated denial | 34/34 |
| Overall gate passed | true |
| Gate failures | 0 |
| Enabled success coverage | 229/229 |
| Error/access coverage | 263/263 |
...
| getCurrentUser | GET | `/me` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 503 |
| completeCurrentStudentProfile | POST | `/me/student-profile` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
...
| createCourse | POST | `/courses` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| getCourse | GET | `/courses/{courseId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| updateCourse | PATCH | `/courses/{courseId}` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
...
| issueJoinCapability | POST | `/course-invites/{inviteToken}/join-capabilities` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 400, 410, 422 |
...
| createExerciseRecordDraft | POST | `/exercise-records` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409, 422 |
| getExerciseRecord | GET | `/exercise-records/{recordId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 404 |
...
| listScoreRules | GET | `/class-sections/{classSectionId}/score-rules` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| createScoreRule | POST | `/class-sections/{classSectionId}/score-rules` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| getScoreRule | GET | `/score-rules/{scoreRuleId}` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| submitScoreRuleForApproval | POST | `/score-rules/{scoreRuleId}/submit-approval` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| approveScoreRule | POST | `/score-rules/{scoreRuleId}/approve` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| rejectScoreRule | POST | `/score-rules/{scoreRuleId}/reject` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| listStudentScores | GET | `/student-scores` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| getStudentScore | GET | `/student-scores/{studentScoreId}` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| recalculateStudentScore | POST | `/student-scores/{studentScoreId}/recalculate` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| publishStudentScore | POST | `/student-scores/{studentScoreId}/publish` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
...
| listScoreAdjustments | GET | `/student-scores/{studentScoreId}/adjustments` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| createScoreAdjustment | POST | `/student-scores/{studentScoreId}/adjustments` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| approveScoreAdjustment | POST | `/score-adjustments/{scoreAdjustmentId}/approve` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
| rejectScoreAdjustment | POST | `/score-adjustments/{scoreAdjustmentId}/reject` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403 |
...
| reviewV81Record | POST | `/exercise-records/{recordId}/v81-reviews` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 422 |
| getV81RecordWorkflow | GET | `/exercise-records/{recordId}/workflow` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| submitV81Supplement | POST | `/exercise-records/{recordId}/supplements` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| correctV81Record | POST | `/exercise-records/{recordId}/corrections` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| getV81MaintenanceAnnouncement | GET | `/system-mode/announcement` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 503 |
| getV81SystemModeHistory | GET | `/system-mode/history` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 422 |
| changeV81SystemMode | POST | `/system-mode/changes` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| getV81SupplementClock | GET | `/exercise-records/{recordId}/supplement-clock` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
...
| createV81VerifiedSubadmin | POST | `/admin/subadmins` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| setV81SubadminStatus | POST | `/admin/subadmins/{id}/status` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409, 422 |
| listV81StudentProgress | GET | `/student-progress` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403 |
| listV81TeacherProgress | GET | `/teacher-progress` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 422 |
| getV81ProgressTarget | GET | `/class-sections/{id}/progress-target` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| listV81Certifications | GET | `/activity-certification-applications` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| listV81RecognitionRevisions | GET | `/activity-certification-applications/{id}/recognition-allocation-revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| adjustV81Recognition | POST | `/activity-certification-applications/{id}/recognition-allocation-revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422, 500 |
| revokeV81Certification | POST | `/activity-certification-applications/{id}/revoke` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 500 |
| getV81ManualMode | GET | `/admin/review-services/manual-mode/{classSectionId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| acceptV81SwimIntake | POST | `/exercise-records/{recordId}/swim-intake` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| getV81SwimIntake | GET | `/exercise-records/{recordId}/swim-intake` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 404 |
| listV81ProofTodos | GET | `/student/proof-todos` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
...
| listV81EnduranceTables | GET | `/admin/endurance-tables` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403 |
| createV81EnduranceRule | POST | `/admin/endurance-tables/rules` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403 |
| updateV81EnduranceRule | POST | `/admin/endurance-tables/rules/{ruleId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| deleteV81EnduranceRule | POST | `/admin/endurance-tables/rules/{ruleId}/delete` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 422 |
| listV81PhysicalResults | GET | `/enrollments/{enrollmentId}/physical-results` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 404 |
| appendV81PhysicalResult | POST | `/enrollments/{enrollmentId}/physical-results` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| getV81StudentPhysicalResult | GET | `/student/enrollments/{enrollmentId}/physical-result` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| createV81PhysicalImport | POST | `/class-sections/{classSectionId}/physical-imports` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| listV81PhysicalImports | GET | `/class-sections/{classSectionId}/physical-imports` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81PhysicalImport | GET | `/physical-imports/{importId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| reviseV81PhysicalImport | POST | `/physical-imports/{importId}/revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409 |
| listV81PhysicalImportRevisions | GET | `/physical-imports/{importId}/revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| confirmV81PhysicalImport | POST | `/physical-imports/{importId}/confirm` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409, 422 |
| getV81PhysicalImportSource | GET | `/physical-imports/{importId}/source` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| createV81PhysicalXlsxImport | POST | `/class-sections/{classSectionId}/physical-imports/xlsx` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 422 |
| previewV81TeacherImport | POST | `/admin/teacher-imports/preview` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403 |
| confirmV81TeacherImport | POST | `/admin/teacher-imports/confirm` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| listV81TeacherAccounts | GET | `/admin/teacher-accounts` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403 |
...
| previewV81RosterRegistration | GET | `/roster-imports/{rosterImportId}/registration-preview` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| getV81RosterConfirmation | GET | `/roster-imports/{rosterImportId}/confirmation` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| confirmV81Roster | POST | `/roster-imports/{rosterImportId}/confirmation` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409 |
| previewV81CompositeRoster | GET | `/class-sections/{classSectionId}/composite-roster` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| exportV81CompositeRosterPreview | GET | `/class-sections/{classSectionId}/composite-roster/export` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81RosterSource | GET | `/roster-imports/{rosterImportId}/source` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81OwnRosterStatus | GET | `/enrollments/{enrollmentId}/roster-status` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 404 |
| getV81AdminRosterSummary | GET | `/admin/class-sections/{classSectionId}/roster-summary` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81AdminCourseDirectory | GET | `/admin/course-directory` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403 |
| getV81AdminPhysicalSummary | GET | `/admin/class-sections/{classSectionId}/physical-summary` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| createV81OcrRosterBatch | POST | `/class-sections/{classSectionId}/ocr-roster-batches` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409 |
| createV81OcrPhysicalBatch | POST | `/class-sections/{classSectionId}/ocr-physical-batches` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409 |
| listV81OcrBatches | GET | `/class-sections/{classSectionId}/ocr-batches` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81OcrBatch | GET | `/ocr-batches/{batchId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| getV81OcrPageSource | GET | `/ocr-batches/{batchId}/pages/{pageId}/source` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81OcrPageRecognition | GET | `/ocr-batches/{batchId}/pages/{pageId}/recognition` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| createV81OcrJob | POST | `/ocr-batches/{batchId}/pages/{pageId}/recognition` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409 |
| getV81OcrJob | GET | `/ocr-jobs/{jobId}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| getV81OcrDraft | GET | `/ocr-batches/{batchId}/draft` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404, 422 |
| createV81OcrDraft | POST | `/ocr-batches/{batchId}/draft` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| reviseV81OcrDraft | POST | `/ocr-batches/{batchId}/draft/revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 409, 422 |
| getV81OcrPhysicalConfirmation | GET | `/ocr-batches/{batchId}/physical-confirmations` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 404 |
| confirmV81OcrPhysicalRows | POST | `/ocr-batches/{batchId}/physical-confirmations` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| getV81OcrRosterConfirmation | GET | `/ocr-batches/{batchId}/roster-confirmation` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| confirmV81OcrRoster | POST | `/ocr-batches/{batchId}/roster-confirmation` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| getV81RosterBasis | GET | `/class-sections/{classSectionId}/roster-basis` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| selectV81RosterBasis | POST | `/class-sections/{classSectionId}/roster-basis` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| listV81ConfirmedRosterSnapshots | GET | `/class-sections/{classSectionId}/roster-basis/snapshots` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 422 |
...
| createV81RuntimeArchive | POST | `/admin/runtime-archives` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 202 | 401, 403, 422 |
| getV81RuntimeArchive | GET | `/admin/runtime-archives/{id}` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| cancelV81RuntimeArchive | POST | `/admin/runtime-archives/{id}/cancellation` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| createV81RuntimeArchiveDownload | POST | `/admin/runtime-archives/{id}/download-url` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| downloadV81RuntimeArchive | GET | `/admin/runtime-archives/{id}/content` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 404 |
| setV81SubadminPermissions | POST | `/admin/subadmins/{id}/permissions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| requestCurrentUserAccountDeletionChallenge | POST | `/me/account-deletion-challenges` | RUNTIME_CONFORMANT | INTENTIONALLY_DISABLED_VALIDATED | - | 401, 403, 503 |
| getV81OcrService | GET | `/admin/review-services/ocr` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403 |
| listV81OcrServiceRevisions | GET | `/admin/review-services/ocr/revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403 |
| saveV81OcrService | POST | `/admin/review-services/ocr/revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
...
| deleteV81TeacherAccount | POST | `/admin/teachers/{id}/delete` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409, 422 |
| deleteV81Course | POST | `/class-sections/{id}/delete` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| deleteV81StudentAccount | POST | `/admin/students/{id}/delete` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
...
| revokeV81CourseInvite | POST | `/class-sections/{classSectionId}/course-invites/revocations` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409 |
...
| correctV81FinalGrade | POST | `/enrollments/{enrollmentId}/final-grades/corrections` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422, 500 |
| correctV81PhysicalResult | POST | `/enrollments/{enrollmentId}/physical-results/corrections` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422, 500 |
| reportClientError | POST | `/audit-logs/client-errors` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 409, 422, 429 |
| listV81TeacherSemesters | GET | `/teacher/semesters` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401, 403, 422 |
| issueMemberJoinCapability | POST | `/course-invites/{inviteToken}/join-capabilities/member` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| getV81HistorySettings | GET | `/class-sections/{classSectionId}/history-settings` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| saveV81HistorySettings | POST | `/class-sections/{classSectionId}/history-settings` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| createV81HistoricalSession | POST | `/enrollments/{enrollmentId}/historical-sessions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| getV81ExerciseGoal | GET | `/admin/exercise-goal` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
| saveV81ExerciseGoal | POST | `/admin/exercise-goal` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
