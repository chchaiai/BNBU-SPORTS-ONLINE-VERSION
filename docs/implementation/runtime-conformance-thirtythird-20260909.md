...
| createV81OcrRosterBatch | POST | `/class-sections/{classSectionId}/ocr-roster-batches` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404 |
| createV81OcrPhysicalBatch | POST | `/class-sections/{classSectionId}/ocr-physical-batches` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
