...
| adjustV81Recognition | POST | `/activity-certification-applications/{id}/recognition-allocation-revisions` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 404, 409, 422 |
| revokeV81Certification | POST | `/activity-certification-applications/{id}/revoke` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409 |
