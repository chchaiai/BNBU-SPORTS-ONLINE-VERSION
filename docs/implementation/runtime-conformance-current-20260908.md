...
| Runtime validation complete | 126 |
| Runtime validation incomplete | 123 |
| No observed response | 1 |
| Intentionally disabled with validated denial | 17/17 |
| Overall gate passed | false |
| Gate failures | 126 |
| Enabled success coverage | 109/232 |
| Error/access coverage | 248/249 |
...
| cancelExerciseSession | POST | `/exercise-sessions/{sessionId}/cancel` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 200 | 401 |
...
| getV81CourseRules | GET | `/class-sections/{classSectionId}/v81-rules` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| saveV81CourseRules | POST | `/class-sections/{classSectionId}/v81-rules` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
...
| getV81MaintenanceAnnouncement | GET | `/system-mode/announcement` | RUNTIME_VALIDATION_INCOMPLETE | NOT_OBSERVED | - | - |
| getV81SystemModeHistory | GET | `/system-mode/history` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| changeV81SystemMode | POST | `/system-mode/changes` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| getV81AccountSecurity | GET | `/auth/account-security` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| changeOwnV81Password | POST | `/auth/own-password` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| listV81Subadmins | GET | `/admin/subadmins` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| createV81VerifiedSubadmin | POST | `/admin/subadmins` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| setV81SubadminStatus | POST | `/admin/subadmins/{id}/status` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| getV81SettlementCheck | GET | `/class-sections/{classSectionId}/settlement-check` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| appendV81PhysicalResult | POST | `/enrollments/{enrollmentId}/physical-results` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| createV81Semester | POST | `/admin/semesters` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| listV81Semesters | GET | `/admin/semesters` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| updateV81Semester | POST | `/admin/semesters/{id}` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| confirmV81Roster | POST | `/roster-imports/{rosterImportId}/confirmation` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| listV81MakeupWindows | GET | `/class-sections/{classSectionId}/makeup-windows` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| createV81MakeupWindow | POST | `/class-sections/{classSectionId}/makeup-windows` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| revokeV81MakeupWindow | POST | `/makeup-windows/{windowId}/revocation` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| listV81OwnMakeupWindows | GET | `/enrollments/{enrollmentId}/makeup-windows` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| getV81SemesterSwitchCheck | GET | `/admin/semesters/{id}/switch-check` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| listV81RuleTemplates | GET | `/rule-templates` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| publishV81RuleTemplate | POST | `/rule-templates` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401 |
| getV81RuleTemplate | GET | `/rule-templates/{id}` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| listV81AuditEvents | GET | `/admin/audit-events` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| getV81AuditEvent | GET | `/admin/audit-events/{source}/{eventId}` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| setV81SubadminPermissions | POST | `/admin/subadmins/{id}/permissions` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
...
| requestV81SubadminIdentity | POST | `/admin/subadmin-identity-challenges` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| verifyV81SubadminIdentity | POST | `/admin/subadmin-identity-challenges/{id}/verify` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| updateV81VerifiedSubadmin | POST | `/admin/subadmins/{id}/profile` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| deleteV81Subadmin | POST | `/admin/subadmins/{id}/delete` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| createV81TeacherCourse | POST | `/teacher/courses` | RUNTIME_CONFORMANT | BOTH_VALIDATED | 201 | 401, 403, 409 |
...
| confirmV81Settlement | POST | `/class-sections/{classSectionId}/settlement-reports` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| listV81SettlementReports | GET | `/class-sections/{classSectionId}/settlement-reports` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| getV81SettlementReport | GET | `/class-sections/{classSectionId}/settlement-reports/{version}` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| exportV81SettlementReport | GET | `/class-sections/{classSectionId}/settlement-reports/{version}/export` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| previewV81Settlement | GET | `/class-sections/{classSectionId}/settlement-preview` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| getV81StudentSettlementResult | GET | `/student/enrollments/{enrollmentId}/settlement-result` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| switchV81Semester | POST | `/admin/semesters/{id}/switch` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
| getV81AdminSettlementSummary | GET | `/admin/class-sections/{classSectionId}/settlement-summary` | RUNTIME_VALIDATION_INCOMPLETE | ERROR_RESPONSE_VALIDATED | - | 401 |
