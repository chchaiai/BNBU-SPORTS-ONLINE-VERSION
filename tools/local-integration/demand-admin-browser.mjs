...
try {
 ...
 await fs.writeFile('evidence/demand-20260916/browser/admin-outbox-result.json',JSON.stringify({requirement:21,realOverviewEntry:true,backlog:data.backlog,eventTypeFilter:eventType,apiStatus:200},null,2));
 await page.screenshot({path:'evidence/demand-20260916/browser/admin-overview.png',fullPage:true});
