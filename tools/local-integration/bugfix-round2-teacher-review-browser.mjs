...
if(purpose&&!['supplement','supplement-once','positive-credit','round2-positive-credit','round2-submit-retry','maintenance-supplement'].includes(purpose))throw new Error('Unsupported synthetic fixture purpose');
