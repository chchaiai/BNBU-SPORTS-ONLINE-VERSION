...
assert not (directory/'semester-archive-denials-v2.json').exists()
...
for host,target in [('/etc/bnbu-sports-production/secrets/runtime.json','/run/secrets/runtime.json'),('/etc/bnbu-sports-production/secrets/tencentdb-ca-chain.pem','/run/secrets/tencentdb-ca-chain.pem'),('/home/ubuntu/semester-create-only.mjs','/app/semester-create-only.mjs'),('/home/ubuntu/semester-archive-denials.mjs','/app/semester-archive-denials.mjs')]:args+=['-v',host+':'+target+':ro']
args+=['-v',str(directory)+':/acceptance','--entrypoint','node',image,'/app/semester-archive-denials.mjs']
