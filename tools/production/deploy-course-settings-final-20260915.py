...
work = Path('/home/ubuntu/bnbu-course-settings-final-20260915')
previous = base / 'releases/course-settings-ui-20260915'
release = base / 'releases/course-settings-final-20260915'
tag = 'bnbu-portal-production:course-settings-final-20260915'
gate = json.loads((work / 'validation.json').read_text())
assert gate['checks'] == {'focusedTests': '2/2 HTTP and browser', 'typecheck': 'PASS', 'build': 'PASS'}
...
assert output(['docker', 'image', 'inspect', '--format', '{{.Id}}', 'bnbu-portal-production:course-settings-ui-20260915']) == gate['basePortalImage']
...
def switch(target):
    link = base / 'current-course-settings-ui-tmp'
