...
try{
 ...
 fixture=await seedFoundationFixture(db,'-LIMIT12-'+suffix);
 ...
 writeFileSync('/acceptance/exercise-limits-20260912.json',JSON.stringify({fixture,student,studentSession,teacherToken:teacher,adminToken:admin,teacher:{email:teacherUser.primaryEmail,password},admin:{email:adminUser.primaryEmail,password},createdAt:new Date().toISOString()}),{mode:0o600,flag:'wx'});
