...
work = Path('/home/ubuntu/bnbu-course-settings-ui-20260915')
previous = base / 'releases/course-settings-20260915'
release = base / 'releases/course-settings-ui-20260915'
tag = 'bnbu-portal-production:course-settings-ui-20260915'
...
assert output(['docker', 'image', 'inspect', '--format', '{{.Id}}', 'bnbu-portal-production:course-settings-20260915']) == gate['basePortalImage']
