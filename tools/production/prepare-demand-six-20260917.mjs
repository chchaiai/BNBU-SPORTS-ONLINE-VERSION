...
try{
 ...
 fixture=await seedFoundationFixture(db,'-SIX17-'+suffix);
 ...
 const template=await request(admin,'/rule-templates',{displayName:'Demand 1-6 cloud acceptance',expectedVersion:0});
 ...
 writeFileSync('/acceptance/demand-six-20260917.json',JSON.stringify({fixture,student,studentSession,teacherToken:teacher,adminToken:admin,accounts:{teacher:{email:teacherUser.primaryEmail,password},admin:{email:fixture.adminEmail,password}},createdAt:new Date().toISOString()}),{mode:0o600,flag:'wx'});
