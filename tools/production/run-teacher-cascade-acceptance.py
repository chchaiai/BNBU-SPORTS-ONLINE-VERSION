...
assert current.name in ['e4bd83eb4b5f-student-delete','c33f037b-teacher-cascade']
...
mode=sys.argv[1];commands={'prepare':('prepare-teacher-cascade.mjs',[]),'verify':('verify-teacher-cascade.mjs',[])}
...
if mode=='prepare':subprocess.run(['install','-o','ubuntu','-g','ubuntu','-m','0600',str(work/'long-acceptance/teacher-cascade-private.json'),str(work/'teacher-cascade-cloud-private.json')],check=True)
