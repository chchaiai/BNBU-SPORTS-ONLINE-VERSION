...
try{
 ...
 fixture=await seedFoundationFixture(db,'-BUG15-'+suffix);
 ...
 const template=await request(admin,'/rule-templates',{displayName:'Bug 20260915 cloud acceptance',expectedVersion:0});
 ...
 writeFileSync('/acceptance/bug-20260915.json',JSON.stringify({fixture,student,studentSession,teacherToken:teacher,adminToken:admin,accounts:{teacher:{email:teacherUser.primaryEmail,password}},createdAt:new Date().toISOString()}),{mode:0o600,flag:'wx'});
