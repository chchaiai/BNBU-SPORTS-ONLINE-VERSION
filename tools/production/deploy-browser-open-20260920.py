...
BASE=Path('/opt/bnbu-sports-production');WORK=Path('/home/ubuntu/bnbu-browser-open-20260920/bundle');RELEASE=BASE/'releases/browser-open-20260920'
...
assert previous==BASE/'releases/student-account-goals-20260920'
...
assert gate['checks']=={'tests':100,'smoke':87,'browserScenarios':12}
...
try:
 ...
 for name,digest in gate['files'].items():
  for suffix in ['', '?verify=browser-open-20260920']:
