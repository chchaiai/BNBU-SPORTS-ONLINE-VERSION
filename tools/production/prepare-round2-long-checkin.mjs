...
try{
 ...
 fixture=await seedFoundationFixture(db,'-LONG-'+suffix);
 ...
 const template=await request(admin,'/rule-templates',{displayName:'Long check-in cloud acceptance',expectedVersion:0});
 ...
 writeFileSync('/acceptance/long-checkin.json',JSON.stringify({fixture,student,studentSession,teacher:{email:teacherUser.primaryEmail,password},createdAt:new Date().toISOString()}),{mode:0o600,flag:'wx'});
 console.log(JSON.stringify({check:'LONG_CLOUD_CHECKIN_FIXTURE_READY',result:'PASS',organizationId:fixture.organizationId,classSectionId:fixture.teacherAActiveSectionId,studentId:student.studentId,teacherId:fixture.teacherUserId,sessionSetup:'isolated synthetic fixture; SMTP not tested'}));
