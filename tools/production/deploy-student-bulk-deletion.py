...
work = Path('/home/ubuntu/bnbu-student-bulk-deletion-20260914')
previous = base / 'releases/credit-projection-0077-20260914'
release = base / 'releases/student-bulk-deletion-20260914'
tag = 'bnbu-portal-production:student-bulk-deletion-20260914'
gate = json.loads((work / 'validation.json').read_text())
assert gate['checks'] == {'focusedTests': '45/45', 'typecheck': 'PASS', 'build': 'PASS'}
...
assert output(['docker', 'image', 'inspect', '--format', '{{.Id}}', 'bnbu-portal-production:invite-duration-20260914']) == gate['basePortalImage']
