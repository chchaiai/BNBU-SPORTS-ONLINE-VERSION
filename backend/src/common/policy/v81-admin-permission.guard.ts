...
const operations: Record<string, AdminPermission | 'SUPER' | 'ANY'> = {
  ...
  getV81ManagementInsights: 'SUPER',
  getV81TeacherDetails: 'USER_ACCOUNTS',
  updateV81TeacherDetails: 'USER_ACCOUNTS',
  ...
  accessFeedbackAttachment: 'STUDENT_FEEDBACK',
  listFeedbackAttachments: 'STUDENT_FEEDBACK',
  ...
  getExerciseRecordEvidenceContext: 'COURSE_VIEW',
  getMediaEvidence: 'COURSE_VIEW',
  createMediaAccessUrl: 'COURSE_VIEW',
  ...
  listAdminOutboxEvents: 'AUDIT_QUERY',
